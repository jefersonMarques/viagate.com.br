...
func (application *Application) routes() http.Handler {
	...
	mux.HandleFunc("GET /analises", application.analyses)
	mux.HandleFunc("GET /analises/{slug}", application.analysis)
	...
	mux.HandleFunc("GET /termos-uso-politica-privacidade", application.legal)
	mux.HandleFunc("GET /politica-de-privacidade", application.redirect("/termos-uso-politica-privacidade#politica-de-privacidade"))
	mux.HandleFunc("GET /termos-de-uso", application.redirect("/termos-uso-politica-privacidade#termos-de-uso"))
